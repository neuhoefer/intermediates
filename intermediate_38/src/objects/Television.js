...
export default class Television extends THREE.Group {
  ...
  updateFunctionalState() {
    ...
    if (powerOn) {
      if (antennaUp) {
        console.log('Screen shows movie');
        if (volumeHigh) {
          console.log('Movie volume is high');
        } else {
          console.log('Movie volume is low');
        }
      } else {
        console.log('Screen shows noise');
        if (volumeHigh) {
          console.log('Noise volume is high');
        } else {
          console.log('Noise volume is low');
        }
      }
    } else {
